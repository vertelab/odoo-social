...
def _post_init_load_dashboards(env):
    """Load the planner dashboards and place their menus under the Social app."""
    dashboards = [
        ("social_planner_dashboard", "data/dashboards/content_creator.yaml", 20),
        ("social_planner_dashboard", "data/dashboards/community_manager.yaml", 30),
        ("social_planner_dashboard", "data/dashboards/content_approver.yaml", 40),
        ("social_planner_dashboard", "data/dashboards/social_manager.yaml", 50),
    ]
    parent_menu = env.ref(
